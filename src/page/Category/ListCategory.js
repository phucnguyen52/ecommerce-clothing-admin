...
const ListCategory = () => {
    ...
    return (
        ...
        <ModalCategory type="create" open={openCreate} setOpen={setOpenCreate} fetchCategory={fetchCategories}/>
        <ModalCategory type="update" open={openUpdate} setOpen={setOpenUpdate} fetchCategory={fetchCategories} data={dataRow}/>
        </>
